                ...
                appBar: AppBar(
                  ...
                  actions: [
                    adServicesController.isAddingToFavourites.value
                        ...
                        : adServicesController.isAdFavourite(widget.adId).value
                        ? IconButton(
                      onPressed: () {
                        ...
                        adServicesController.getFavouriteAds(widget.adId);
                      },
                      icon: Icon(
                        Icons.favorite,
                        color: Colors.red,
                      ...
                      onPressed: () {
                        adServicesController.addAdToFavourites(
                            adModel: widget.ad,
                            userId: homeController.userId ?? "");                        adServicesController.getFavouriteAds(widget.adId);
