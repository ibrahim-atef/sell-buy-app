...
class RecentlyViewedAds extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GetBuilder<AdServicesController>(builder: (_) {
        if (adServicesController.recentlyViewedAds.isEmpty) {
          return Center(child: Text('No Ads Found'.tr));
        }
        return adServicesController.isGettingRecentlyViewed.value
            ? ListView.builder(
            ...
            : ListView.builder(
                itemCount: adServicesController.recentlyViewedAds.length,
                itemBuilder: (_, index) {
                  AdModel ad = adServicesController.recentlyViewedAds[index];
                  return Padding(
